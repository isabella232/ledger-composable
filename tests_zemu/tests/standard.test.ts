...
import { newComposableApp } from '@zondax/ledger-substrate'
...
describe('Standard', function () {
  ...
  test.each(models)('get app version', async function (m) {
    ...
    try {
      await sim.start({ ...defaultOptions, model: m.name })
      const app = newComposableApp(sim.getTransport())
  ...
  test.each(models)('get address', async function (m) {
    ...
    try {
      ...
      const expected_address = '5ygGAKSAha7GEzRMPkh98SiKbJ21FStMizgYPoHFriWspTu9'
